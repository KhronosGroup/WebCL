...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="api">
    <a href="http://www.khronos.org/registry/webcl/specs/{@version}/">WebCL API <xsl:value-of select="@version"/></a>
  </xsl:template>

  <xsl:template match="ext">
    <a href="http://www.khronos.org/registry/webcl/extensions/{@name}/">
